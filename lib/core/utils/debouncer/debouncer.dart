...
import 'package:test_shop_task/core/utils/debouncer/behavior_type.dart';
...
class Debouncer {
  ...
  /// Debounces the provided [VoidCallback] function by canceling any existing
  /// timer and scheduling a new timer to invoke the callback after the
  /// specified [duration] of inactivity.
  ///
  /// The [VoidCallback] function is invoked only once, even if this method is
